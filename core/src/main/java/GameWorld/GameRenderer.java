...
public class GameRenderer {
    ...
    public void render(float runTime){
        ...
        if(bird.notFlap()){
            ...
            batcher.draw(
                birdAnimation.getKeyFrame(runTime*2),
                bird.getX(), bird.getY(),
                bird.getWidth()/2.0f, bird.getHeight()/2.0f,
                bird.getWidth(), bird.getHeight(),
                1, 1,
    ...
    private void drawSkulls(){
        batcher.draw(
            skullUp,
            pipe1.getX() -1, pipe1.getY() + pipe1.getHeight() - 14,
            24, 14
        );

        batcher.draw(
            skullDown,
            pipe1.getX()-1, pipe1.getY() + pipe1.getHeight() + 45,
            24, 14
        );

        batcher.draw(
            skullUp,
            pipe2.getX() -1, pipe2.getY() + pipe2.getHeight() - 14,
            24, 14
        );

        batcher.draw(
            skullDown,
            pipe2.getX()-1, pipe2.getY() + pipe2.getHeight() + 45,
            24, 14
        );

        batcher.draw(
            skullUp,
            pipe3.getX() -1, pipe3.getY() + pipe3.getHeight() - 14,
            24, 14
        );

        batcher.draw(
            skullDown,
            pipe3.getX()-1, pipe3.getY() + pipe3.getHeight() + 45,
            24, 14
        );
    }
    ...
    private void drawPipes(){
        ...
        batcher.draw(
            bar,
            pipe1.getX(), pipe1.getY() + pipe1.getHeight() + 45,
        ...
        batcher.draw(
            bar,
            pipe2.getX(), pipe2.getY() + pipe2.getHeight() + 45,
        ...
        batcher.draw(
            bar,
            pipe3.getX(), pipe3.getY() + pipe3.getHeight() + 45,
